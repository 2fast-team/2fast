...
namespace Project2FA.UWP.Utils
{
    ...
    /// </summary>
    public class CustomRichTextButtonActions : ButtonActions
    {
        /// <summary>
        ...
        public CustomRichTextButtonActions(CustomRichTextFormatter formatter)
        {
            Formatter = formatter;
        }
        ...
        /// </summary>
        public CustomRichTextFormatter Formatter { get; }
    }
}
